...
const resumeLink =
    "https://drive.google.com/file/d/1TedwotfCDZKd_xtziZjrO206qh2eoi6U/view?usp=sharing";
        ...
        <Container>
            <Div1>
                <Link href="/">
                    ...
                    >
                        <MainIcon size="2.5rem" />{" "}
                        <Span>&nbsp;Yuanqin.Fan</Span>
                    </a>
                </Link>
            </Div1>
            <Div2>
                <li>
                    <Link href={"/work"}>
                        <NavLink
                            main={currentActivatedTab === "/work" ? "main" : ""}
                        >
                            Work
                        </NavLink>
                    </Link>
          ...
          <Link href={"#tech"}>
            <NavLink>Technologies</NavLink>
                ...
                <li>
                    <Link href={"/about"}>
                        <NavLink
                            main={
                                currentActivatedTab === "/about" ? "main" : ""
                            }
                        >
                            About
                        </NavLink>
            ...
            <Div3>
                ...
                <SocialIcons
                    href="https://www.linkedin.com/in/yuanqinf/"
                    target="_blank"
                >
